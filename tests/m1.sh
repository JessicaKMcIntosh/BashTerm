...
test::m1_comments() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Comments should not be printed."
}
...
test::m1_define() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Define a variable."
}
...
test::m1_default() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Default value for an undefined variable."
}
...
test::m1_if() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "If a variable is true."
}
...
test::m1_unless() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Unless a variable is true."
}
...
test::m1_undefine() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Undefine a variable."
}
...
test::m1_ignore() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Ignore text between delimiters."
}
...
test::m1_stderr() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk - 2>&1" "0" "${test_result}" "Print to STDERR."
}
...
test::m1_system() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Execute a system command."
}
...
test::m1_echo() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Explicitly echo text."
}
...
test::m1_exit() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "2" "${test_result}" "Exit prematurely with the given exit status."
}
...
test::m1_D() {
    ...
    printf -v test_result "Value"
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -- -DVARIABLE=Value -" "0" "${test_result}" "Exit prematurely with the given exit status."
}
...
test::m1_output() {
    ...
    assert_run "echo ${test_data@Q} | awk -f src/utilities/m1.awk -" "0" "${test_result}" "Send output to a file."
